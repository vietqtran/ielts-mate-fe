...
interface AddMarkupFilterProps {
  searchText?: string;
  sortDirection?: 'asc' | 'desc' | '';
  sortBy?: string;
}

interface AddMarkupFilterToolbarProps {
  filters: AddMarkupFilterProps;
  onFiltersChange: (filters: AddMarkupFilterProps) => void;
  onClearFilters: () => void;
  isLoading?: boolean;
...
export const AddMarkupFilter = memo(function AddMarkupFilterToolbar({
  filters,
  onFiltersChange,
  onClearFilters,
  isLoading = false,
  inputPlaceholder = 'Search by exam name...',
}: Readonly<AddMarkupFilterToolbarProps>) {
...
export default AddMarkupFilter;
