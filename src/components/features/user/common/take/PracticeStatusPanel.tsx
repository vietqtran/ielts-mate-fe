...
export interface PracticeStatusPartProgress {
  key: string;
  title: string;
  answered: number;
  total: number;
...
export interface PracticeStatusPanelProps {
  parts: PracticeStatusPartProgress[];
  activeKey: string;
...
export const PracticeStatusPanel: React.FC<PracticeStatusPanelProps> = ({
  parts,
  activeKey,
  onNavigate,
  className,
...
export default PracticeStatusPanel;
