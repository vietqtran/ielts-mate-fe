                      ...
                      {group.questions.map((question, qIndex) => (
                        <div key={qIndex} className="space-y-2">
                          <div 
                            ...
                            dangerouslySetInnerHTML={{ __html: `${question.questionOrder}. ${question.instructionForChoice}` }}
                          />
                    ...
                    <div className="space-y-4">
                      {group.questions.map((question, qIndex) => (
                        <div key={qIndex} className="space-y-2">
                          <div 
                            className="font-medium"
                            dangerouslySetInnerHTML={{ __html: `${question.questionOrder}. ${question.instructionForMatching}` }}
                          />
                  ...
                  return (
                    <div key={type} className="flex justify-between text-sm">
                      ...
                      <span className="text-muted-foreground">
                        {count} group{count !== 1 ? 's' : ''}, {questionCount} question{questionCount !== 1 ? 's' : ''}
                      </span>
                    </div>
                  );
                })}
