...
import { ReadingAttemptFilters } from '@/store/slices/reading-attempt-slice';
...
const ieltsTypeOptions = [
  ...
  { value: String(IeltsTypeEnumIndex.GENERAL_TRAINING), label: 'General Training' },
];
...
const sortOptions = [
  ...
  { value: 'finished_at', label: 'Finish Date' },
  { value: 'title', label: 'Title' },
  { value: 'total_points', label: 'Score' },
...
export const ReadingAttemptFilterToolbar = memo(function ReadingAttemptFilterToolbar({
  ...
  const handleIeltsTypeChange = useCallback(
    (values: string[]) => {
      updateFilter('ieltsTypeList', values.map(Number));
    },
    [updateFilter]
  );
  ...
  const handlePartNumberChange = useCallback(
    (values: string[]) => {
      updateFilter('partNumberList', values.map(Number));
    },
    [updateFilter]
  );
  ...
  const handleStatusChange = useCallback(
    (values: string[]) => {
      updateFilter('statusList', values.map(Number));
    },
    [updateFilter]
  );
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t'>
              <div className='space-y-2'>
                ...
                <MultiSelect
                  ...
                  selected={filters.ieltsTypeList?.map(String) || []}
              ...
              <div className='space-y-2'>
                ...
                <MultiSelect
                  ...
                  selected={filters.partNumberList?.map(String) || []}
              ...
              <div className='space-y-2'>
                ...
                <MultiSelect
                  ...
                  selected={filters.statusList?.map(String) || []}
