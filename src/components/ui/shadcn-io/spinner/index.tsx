...
import { LoaderCircleIcon, LoaderIcon, LoaderPinwheelIcon, LucideProps } from 'lucide-react';
...
const Ellipsis = ({ size = 24, ...props }: SpinnerVariantProps) => {
  return (
    <svg height={size} viewBox='0 24' width={size} xmlns='http://www.w3.org/2000/svg' {...props}>
      <title>Loading...</title>
