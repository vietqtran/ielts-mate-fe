...
export default function SignUpPage() {
  ...
  return (
    <div
      className='flex flex-1 flex-col justify-center px-8 py-12 sm:px-16 lg:px-24'
      data-cy='sign-up-page'
    >
      <div className='mx-auto w-full max-w-sm' data-cy='sign-up-card'>
        ...
        <p className='mt-8 text-center text-sm text-muted-foreground'>
          ...
          <CustomLink href='/sign-in' text='Sign in' data-cy='go-to-sign-in' />
        </p>
